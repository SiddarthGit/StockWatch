...
export default function TradeForm({ target, tick, position, onSubmit, onClose }: Props) {
  ...
  const canSell = (position?.quantity ?? 0) > 0;
    ...
    >
      ...
      >
        ...
        <input
          type="number"
          min={1}
          max={side === "sell" ? position?.quantity : undefined}
          value={quantity}
